...
## 2026-09-16 新增落线（1.0(22)）

David 批准的 #339 / #342 / #341 / #340 / #343 已全部进入 `release/1.0`。#339 原已落线，其余四项随整合 PR #344 于 2026-09-16 合入（9a28115d），原 PR 均为 MERGED。尚未切包或部署配套后端。
...
- #339 已于 09-02 落线，见上方条目。以上四项的独立 PR CI 已于 09-16 全绿；整合代码保留 `73fea6d` 两条失效 lint 豁免清理，整合 PR #344 的完整 CI 亦全绿（run 35064634674：九包 1,922 测试、主工程 9 测试、format/lint）。
...
- **#338 / 动作库分类与旧名同步（T1 / P1）**：David 于 09-16 追加批准，已合入 release/1.0（24d47f65），进入 1.0(22)。捆绑动作库 1,219→1,212，旧名别名 49→61，镜像 backend 0069 并补齐 0025/0028 漂移；线上分类仍以 API 为准，不迁移或改写历史记录。验证见 [#338 验证记录](docs/verification-338-2026-09-16.md)。
