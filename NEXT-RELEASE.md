...
- **#338 / 动作库分类与旧名同步（T1 / P1）**：David 于 09-16 追加批准进入 1.0(22)，随本 PR 合入即落线。捆绑动作库 1,219→1,212，旧名别名 49→61，镜像 backend 0069 并补齐 0025/0028 漂移；线上分类仍以 API 为准，不迁移或改写历史记录。验证见 [#338 验证记录](docs/verification-338-2026-09-16.md)。
