...
- **器械词表 v2**(#206)— Step 4 器械区 13→24 token 分 4 组(基础/哑铃上限单选桶/固定器械/力量举专项),按「影响教练编排」原则筛选;海豹划船凳、地雷架、专项杆硬/软拆分入列;场馆卡加一行副标题;教练端器械备注改中文 label

## 📋 进度:离 archive 推 TestFlight 还差几步
- [x] 改动合到 ship 分支(#196/#198/#199/#203/#193 + #204/#205/#206 全部已合入)
