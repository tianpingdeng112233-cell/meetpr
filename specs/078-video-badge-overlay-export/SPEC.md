...
## 角标卡式样(正典 = `docs/design/video-badge/badge-01.html`,一比一)

⚖️ 2026-08-21 真机走查 David 指定:以其交付的 Claude Design 画布「MeetPR 视频角标 01」为标准,
原始标记与字标 PNG 已落仓 `docs/design/video-badge/`(540×960 画布;卡宽 468、底边距 76、圆角 14、
内边距 13/14/14、行距 10;底色 rgba(10,10,12,.62) + 1px 白 10% 描边;字标=PNG;数字 30/20 号;
「× N」#B6B6BC;RPE 胶囊 22 高、金 15% 底 + 42% 描边;卡下 44% 高 rgba(5,5,7,.72)→0 渐变压暗)。
下文文字复述仅为概览,数值以设计文件为准。
