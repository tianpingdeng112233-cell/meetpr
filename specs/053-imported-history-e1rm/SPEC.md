...
## Amendment 2026-07-17(David 拍板)

- 学员端 e1RM 曲线由 28 天滚动最高改为纯破纪录阶梯线:仅严格破纪录时出新点、永不回落,并向窗口头部与今天平延。
- 学员端移除普通训练组散点;`.low` 隔离点继续以弱化散点可见。
- 「历史最佳」改指近 28 天无新纪录;`smoothed` 滚动窗聚合仍是 spec 050 真源,recorder、教练端及其消费者不变。
