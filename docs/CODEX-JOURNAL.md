...
- 2026-09-16（本次切包提交）— [Codex][prep-beta] David 要求切包；核实 ASC 最高 21 与六项祖先关系，agvtool 升至 22、marketing 保持 1.0；使用独立取包树保留旧树修改。tag CI / demo / 人工上传状态见 [切包记录](prep-beta-1.0-22-2026-09-16.md)。
