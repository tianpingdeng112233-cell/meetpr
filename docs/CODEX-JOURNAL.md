...
- 2026-09-16 2e816526（原实现 8ba5b638）— [Codex][T1/P1] David 追加批准动作库同步进入 1.0(22)；合入最新五项发版基线，功能差异仍为两 JSON 与两测试。CoachKit 443/443 通过；验证及最终 CI 见 [#338 验证记录](verification-338-2026-09-16.md)。
