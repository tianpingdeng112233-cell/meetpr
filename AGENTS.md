...
**下一个测试包 = 1.0 (13)。累积线 = 分支 `release/1.0`。你现在就在这条线上。**
(1.0(12) 已于 2026-07-17 上传,tag `beta/1.0-12`,Neice 免审生效、外测 Ceshi 已提交 Beta App Review;
1.0(11) 2026-07-17 内外测首次同版;1.0(10) 2026-07-13 首个带埋点包;1.0(9) 2026-07-12;
1.0(8) 2026-07-11;内容存档见 RELEASES.md。)
...
- **已完成清单(做了=重复劳动)**:三修 `#231'/#232'/#233'`、`#228`/`#229` 基建、
  捞回队列**序 1–6 全部完成**(#209'/#212'/#222'/#202'/#186'/#221',2026-07-10 收货落线)、
  教练备注学员可见修复(源自 #234,e31dc93)、「我的」空态逃生舱 P0(fadbc3a)——以上全部已随
  1.0(8)(前八项)或 1.0(9)(fadbc3a)发出,核对 `docs/CODEX-JOURNAL.md` 与 git log 为准。
...
| 序 | PR | 一句话 | 体量 | 备注 |
|---|---|---|---|---|
| ~~1-6~~ | ✅ 已完成 | #209/#212/#222/#202/#186/#221 已全部落线并随 1.0(8) 发出 | — | 见上方已完成清单 |
| ~~7-8~~ | ✅ 已完成 | #216 e1RM 单一真源 + #220 误记隔离已落线并随 1.0(9) 发出 | — | 2026-07-11 落线 |
| ~~10~~ | ✅ 已完成 | 顺延已按 spec 054 整体顺延 V2 落线并随 1.0(9) 发出(取代 #234b 单日版) | — | backend 0038 + `sha-e87ffac` 已部署 staging(07-12) |
| ~~9~~ | ✅ 已完成 | #227 导入历史 e1RM 回填 + review gate(spec 053)已落线 | — | 2026-07-16 六子卡重做落线(0308f0f..4c8af71),随下一包发出 |
...
余项现状:序 1–10 全部完成(含序 9 #227,2026-07-16 落线);#234a 仍需 Claude 先拆包,**先不要动**;#215/#217 等 Claude 裁剪卡;序 11(per-set)/ 12(rename)独立可动。
