...
**下一个测试包 = 1.0 (22)。累积线 = 分支 `release/1.0`。你现在就在这条线上。**
(1.0(21) 已于 2026-08-23 上传,tag `beta/1.0-21` @ e826b6f0,含训练提醒 + 视频角标导出 +
六形态强度/% 三锚换算 + 设备时区归日 + 教练 e1RM 同源 + 双端空状态兜底 + 动作别名同步;
1.0(20) 2026-08-20;1.0(19) 2026-08-12;更早各版内容存档见 RELEASES.md。)
