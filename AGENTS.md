...
**下一个测试包 = 1.0 (10)。累积线 = 分支 `release/1.0`。你现在就在这条线上。**
(1.0(9) 已于 2026-07-12 上传发布,tag `beta/1.0-9`;1.0(8) 2026-07-11;内容存档见 RELEASES.md。)
...
| 9 | #227 | 导入历史 e1RM 回填 + review gate(spec 053) | 1788 行 | 依赖的 #216/#220 已落,**已解锁**;体量大,拆子任务卡 |
...
余项现状:序 7→8 已落(串行链只剩序 9 #227,已解锁);#234a 仍需 Claude 先拆包,**先不要动**;#215/#217 等 Claude 裁剪卡;序 11(per-set)/ 12(rename)独立可动。
