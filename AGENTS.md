...
**下一个测试包 = 1.0 (12)。累积线 = 分支 `release/1.0`。你现在就在这条线上。**
(1.0(11) 已于 2026-07-17 上传,tag `beta/1.0-11`,外测 Ceshi 已过审在 Testing、与 Neice 首次同版;
1.0(10) 2026-07-13 首个带埋点包;1.0(9) 2026-07-12;1.0(8) 2026-07-11;内容存档见 RELEASES.md。)
