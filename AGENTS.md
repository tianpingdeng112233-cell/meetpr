...
**下一个测试包 = 1.0 (9)。累积线 = 分支 `release/1.0`。你现在就在这条线上。**
(1.0(8) 已于 2026-07-11 上传 ASC 并分配 Neice,tag `beta/1.0-8`;内容存档见 RELEASES.md。)
...
- **已完成清单(做了=重复劳动)**:三修 `#231'/#232'/#233'`、`#228`/`#229` 基建、
  ...
  教练备注学员可见修复(源自 #234,e31dc93)、「我的」空态逃生舱 P0(fadbc3a)——以上全部已在
  1.0(8)(前八项)或 1.0(9) 累积中(fadbc3a),核对 `docs/CODEX-JOURNAL.md` 与 git log 为准。
