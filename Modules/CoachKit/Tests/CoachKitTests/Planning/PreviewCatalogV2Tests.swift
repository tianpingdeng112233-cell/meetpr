...
@available(iOS 17.0, macOS 14.0, *)
@Test func previewCatalogTotalCountIsFiveThirty() async throws {
  let catalog = try await previewCatalog()

  #expect(catalog.count == 530)
  #expect(InMemoryPlanRepository.loadBundledCatalogV2().count == 526)
