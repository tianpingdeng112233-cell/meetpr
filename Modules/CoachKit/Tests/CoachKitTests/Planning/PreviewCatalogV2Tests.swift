...
@available(iOS 17.0, macOS 14.0, *)
@Test func previewCatalogTotalCountIsFiveTwenty() async throws {
  let catalog = try await previewCatalog()

  #expect(catalog.count == 520)
  #expect(InMemoryPlanRepository.loadBundledCatalogV2().count == 516)
