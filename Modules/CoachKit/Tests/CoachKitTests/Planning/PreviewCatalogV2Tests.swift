...
@available(iOS 17.0, macOS 14.0, *)
@Test func previewCatalogTotalCountIsSixTwentyFive() async throws {
  let catalog = try await previewCatalog()

  #expect(catalog.count == 625)
  #expect(InMemoryPlanRepository.loadBundledCatalogV2().count == 621)
