...
@available(iOS 17.0, macOS 14.0, *)
@Test func previewCatalogTotalCountIsSevenFortySeven() async throws {
  let catalog = try await previewCatalog()

  #expect(catalog.count == 747)
  #expect(InMemoryPlanRepository.loadBundledCatalogV2().count == 743)
