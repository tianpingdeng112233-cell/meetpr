...
@available(iOS 17.0, macOS 14.0, *)
@Test func previewCatalogTotalCountIsTwelveFifteen() async throws {
  let catalog = try await previewCatalog()

  #expect(catalog.count == 1215)
  #expect(InMemoryPlanRepository.loadBundledCatalogV2().count == 1211)
