...
@available(iOS 17.0, macOS 14.0, *)
@Test func previewCatalogTotalCountIsEightSixtySix() async throws {
  let catalog = try await previewCatalog()

  #expect(catalog.count == 866)
  #expect(InMemoryPlanRepository.loadBundledCatalogV2().count == 862)
