...
@available(iOS 17.0, macOS 14.0, *)
@Test func previewCatalogTotalCountIsTwelveNineteen() async throws {
  let catalog = try await previewCatalog()

  #expect(catalog.count == 1219)
  #expect(InMemoryPlanRepository.loadBundledCatalogV2().count == 1215)
