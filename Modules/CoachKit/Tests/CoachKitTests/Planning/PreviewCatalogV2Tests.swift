...
@available(iOS 17.0, macOS 14.0, *)
@Test func previewCatalogTotalCountIsTwelveTwentySix() async throws {
  let catalog = try await previewCatalog()

  #expect(catalog.count == 1226)
  #expect(InMemoryPlanRepository.loadBundledCatalogV2().count == 1222)
