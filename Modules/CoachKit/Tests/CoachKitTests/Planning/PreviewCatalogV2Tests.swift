...
@available(iOS 17.0, macOS 14.0, *)
@Test func previewCatalogTotalCountIsSixFiftySeven() async throws {
  let catalog = try await previewCatalog()

  #expect(catalog.count == 657)
  #expect(InMemoryPlanRepository.loadBundledCatalogV2().count == 653)
