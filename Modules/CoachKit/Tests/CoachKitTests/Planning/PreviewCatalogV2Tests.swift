...
@available(iOS 17.0, macOS 14.0, *)
@Test func previewCatalogTotalCountIsNineForty() async throws {
  let catalog = try await previewCatalog()

  #expect(catalog.count == 940)
  #expect(InMemoryPlanRepository.loadBundledCatalogV2().count == 936)
