...
@available(iOS 17.0, macOS 14.0, *)
@Test func previewCatalogTotalCountIsTwelveSixteen() async throws {
  let catalog = try await previewCatalog()
  ...
  // Backend 0069 catalog audit (2026-08-23): +4 entries missed from backend 0025,
  // −1 (0025 deleted 宽距高位下拉), −10 cross-category merges: 1219→1212.
  #expect(catalog.count == 1216)
  #expect(InMemoryPlanRepository.loadBundledCatalogV2().count == 1212)
