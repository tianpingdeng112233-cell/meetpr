...
/// Live coach account ledger backed by DELETE /me and PUT /me/password.
public struct BackendCoachAccountRepository: AccountRepository {
...
public actor InMemoryCoachAccountRepository: AccountRepository {
