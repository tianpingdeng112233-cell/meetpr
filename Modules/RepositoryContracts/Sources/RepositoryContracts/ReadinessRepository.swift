...
/// Student readiness check-in store (spec 030 §C). V0.1 collects and reads
/// the current day only — no score (ADR-001); the coach side consumes the
/// same fetch in spec 029's second pass.
