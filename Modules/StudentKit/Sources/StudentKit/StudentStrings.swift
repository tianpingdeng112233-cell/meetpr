...
enum StudentStrings {
  ...
  struct Key {
    ...
    static let e1rmSourceDailyBest = Key("student.e1rmSourceDailyBest")
    static let e1rmSourceImported = Key("student.e1rmSourceImported")
    static let e1rmSourceLow = Key("student.e1rmSourceLow")
    static let e1rmSourceLabel = Key("student.e1rmSourceLabel")
    static let e1rmSourceMissingSet = Key("student.e1rmSourceMissingSet")
    static let e1rmSourceMissingExercise = Key("student.e1rmSourceMissingExercise")
    static let e1rmSourceSet = Key("student.e1rmSourceSet")
    static let e1rmSourceRecord = Key("student.e1rmSourceRecord")
    static let e1rmSourceStudentRPE = Key("student.e1rmSourceStudentRPE")
    static let e1rmSourceCoachRPE = Key("student.e1rmSourceCoachRPE")
    static let e1rmSourceNoRPE = Key("student.e1rmSourceNoRPE")
    static let e1rmSourceCalculation = Key("student.e1rmSourceCalculation")
    static let e1rmSourceRTS = Key("student.e1rmSourceRTS")
    static let e1rmSourceEpley = Key("student.e1rmSourceEpley")
    static let e1rmSourceUnavailable = Key("student.e1rmSourceUnavailable")
    static let e1rmSourceNote = Key("student.e1rmSourceNote")
    static let e1rmSourceLowNote = Key("student.e1rmSourceLowNote")
    static let e1rmSourceImportedNote = Key("student.e1rmSourceImportedNote")
    static let e1rmSourceAccessibility = Key("student.e1rmSourceAccessibility")
    static let e1rmSourceHistory = Key("student.e1rmSourceHistory")
    static let e1rmSourceHistoryEmpty = Key("student.e1rmSourceHistoryEmpty")
    static let e1rmSourceHistoryEmptyNote = Key("student.e1rmSourceHistoryEmptyNote")
    ...
    static let todayWorkoutTypes008 = Key("student.todayWorkoutTypes.copy008")
    static let todayWorkoutTypes009 = Key("student.todayWorkoutTypes.copy009")
    static let todayWorkoutTypes010 = Key("student.todayWorkoutTypes.copy010")
    static let todayWorkoutTypes011 = Key("student.todayWorkoutTypes.copy011")
    static let todayWorkoutTypes012 = Key("student.todayWorkoutTypes.copy012")
    static let todayWorkoutTypes013 = Key("student.todayWorkoutTypes.copy013")
    static let todayWorkoutTypes014 = Key("student.todayWorkoutTypes.copy014")
    static let todayWorkoutTypes015 = Key("student.todayWorkoutTypes.copy015")
    static let todayWorkoutTypes016 = Key("student.todayWorkoutTypes.copy016")
    static let todayWorkoutTypes017 = Key("student.todayWorkoutTypes.copy017")
    static let todayWorkoutTypes018 = Key("student.todayWorkoutTypes.copy018")
    static let todayWorkoutTypes019 = Key("student.todayWorkoutTypes.copy019")
    static let todayWorkoutTypes020 = Key("student.todayWorkoutTypes.copy020")
    static let todayWorkoutTypes021 = Key("student.todayWorkoutTypes.copy021")
    static let todayWorkoutTypes022 = Key("student.todayWorkoutTypes.copy022")
    static let todayWorkoutTypes023 = Key("student.todayWorkoutTypes.copy023")
    static let todayWorkoutTypes024 = Key("student.todayWorkoutTypes.copy024")
    static let todayWorkoutTypes025 = Key("student.todayWorkoutTypes.copy025")
    static let todayWorkoutTypes026 = Key("student.todayWorkoutTypes.copy026")
    static let todayWorkoutTypes027 = Key("student.todayWorkoutTypes.copy027")
